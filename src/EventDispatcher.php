  ...
  public function __construct(array $plugins) {
    foreach ($plugins as $plugin) {
      foreach ($plugin->getSubscribedEvents() as $eventName => $eventListeners) {
        // $eventListeners could be the function name. In that case it is a string, and we use the default priority.
        // $eventListeners could also be an array where the first element is a string which is the function name. The
        // second element is optional but could contain the priority.
